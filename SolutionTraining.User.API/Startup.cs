...
using SolutionTraining.User.API.Infrastructure.IoC;

namespace SolutionTraining.User.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SolutionTraining.User.API", Version = "v1" });
            });

            //é ncessario inserir as dependencias que foram requeridas no "UserService"
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "SolutionTraining.User.API v1"));
            }
